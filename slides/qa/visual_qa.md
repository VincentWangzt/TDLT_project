...
- Compiled with `latexmk -xelatex -interaction=nonstopmode -halt-on-error`.
- Rendered all 76 pages with Poppler `pdftoppm` at 120 DPI.
- Built `slides/qa/contact_sheet.png` from the rendered pages.
- Inspected dense result tables, command slides, qualitative plots, appendix parameter/config slides, and references.
